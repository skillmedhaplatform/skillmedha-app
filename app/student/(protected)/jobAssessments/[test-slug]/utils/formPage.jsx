...
const FormPage = ({ initialData }) => {
  ...
  return (
    <div className="w-full h-[calc(100%-10px)] overflow-y-scroll [&::-webkit-scrollbar]:hidden">
      {initialData?.map((item, index) => (
        <div key={index} className="relative">
          <input
            ...
            className="py-[0.3rem] px-[0.5rem] border-none outline-none text-[1rem] rounded-lg my-[0.3rem] w-full"
