...
import { Button, Table, Input, Space, Popconfirm, App, Tooltip } from "antd";
...
const SectionManager = () => {
  ...
  const handleOpenSection = (section) => {
    ...
    nav.push(`/admin/course/${internshipId}/${section._id}/topicDetails`);
  };
  ...
  useEffect(() => {
    if (internshipId?.split("/")?.join("") !== "newCourse") {
      dispatch(
        getOneInternship({
          id: internshipId,
  ...
  return (
    <div className={SecStyles.container}>
      <div className={SecStyles.header}>
        <strong onClick={() => nav.push(`/admin/course/${internshipId}`)}>
          {singleInternship?.title || "Course Management"}
        </strong>
      </div>
