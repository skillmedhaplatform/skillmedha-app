  ...
  return (
    <>
      ...
      <div className="w-full bg-white border border-[#e2e8f0] rounded-[16px] p-6 mb-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-y-6 md:gap-y-0">
          
          <div className="flex flex-col items-center text-center md:border-r border-[#e2e8f0]">
            <div className="w-10 h-10 rounded-full bg-[#eff6ff] flex items-center justify-center text-[#3b82f6] text-[18px] mb-3">
              <TagOutlined />
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">Category</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.sector || "Not specified"}</p>
          </div>

          <div className="flex flex-col items-center text-center md:border-r border-[#e2e8f0]">
            <div className="w-10 h-10 rounded-full bg-[#f0fdf4] flex items-center justify-center text-[#22c55e] text-[18px] mb-3">
              <SolutionOutlined />
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">Function</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.jobTitle || "Not specified"}</p>
          </div>

          <div className="flex flex-col items-center text-center md:border-r border-[#e2e8f0]">
            <div className="w-10 h-10 rounded-full bg-[#f3e8ff] flex items-center justify-center text-[#a855f7] text-[18px] mb-3 font-serif">
              ₹
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">CTC</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.ctc ? `${job.ctc} LPA` : "Not Disclosed"}</p>
          </div>

          <div className="flex flex-col items-center text-center md:border-r border-[#e2e8f0]">
            <div className="w-10 h-10 rounded-full bg-[#fff7ed] flex items-center justify-center text-[#f97316] text-[18px] mb-3">
              <EnvironmentOutlined />
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">Location</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.city || "Not specified"}</p>
          </div>

          <div className="flex flex-col items-center text-center md:border-r border-[#e2e8f0]">
            <div className="w-10 h-10 rounded-full bg-[#f8fafc] flex items-center justify-center text-[#64748b] text-[18px] mb-3">
              <UserOutlined />
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">Job Type</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.jobType || "Not specified"}</p>
          </div>

          <div className="flex flex-col items-center text-center">
            <div className="w-10 h-10 rounded-full bg-[#ecfeff] flex items-center justify-center text-[#06b6d4] text-[18px] mb-3">
              <LaptopOutlined />
            </div>
            <p className="text-[11px] font-extrabold text-[#64748b] uppercase tracking-wider mb-1 m-0">Remote Work</p>
            <p className="text-[14px] font-bold text-[#0f172a] m-0">{job?.remoteWorkAllowed !== undefined ? (job.remoteWorkAllowed ? "Yes" : "No") : "Not specified"}</p>
          </div>
        ...
        <div className="w-full bg-white border border-[#e2e8f0] rounded-[16px] p-6 mb-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex flex-wrap gap-4 ml-11">
            {job.supplementalPay.map((pay, idx) => (
              <div key={idx} className="flex items-center gap-2 px-4 py-3 bg-[#f8fafc] text-[#0f172a] rounded-xl text-[14px] font-semibold border border-[#e2e8f0]">
        ...
        {job?.interviewRounds?.length ? (
          <div className="flex flex-col gap-4">
            {job.interviewRounds.map((round, index) => (
              <div key={index} className="w-full flex p-4 border border-solid border-[#e2e8f0] rounded-xl shadow-sm bg-[#f8fafc]">
          ...
          <div className="p-6 border border-dashed border-[#cbd5e1] rounded-xl flex items-center gap-6 bg-[#f8fafc]">
