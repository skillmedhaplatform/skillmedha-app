...
export default function StudentResult({ params }) {
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} style={{ width: "100%", margin: "0 auto", boxSizing: "border-box", paddingRight: 0, paddingLeft: 0 }}>
        {blockedmsgVal === "blocked" && (
          <Result
            status="error"
            title="Test Blocked"
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: "0.75rem", alignItems: "center", flexWrap: "wrap", minWidth: 0 }}>
                    <Select
                      value={selectedCategory}
                      style={{ width: 160, minWidth: 120, flex: "0 0 auto" }}
                      onChange={(val) => setSelectedCategory(val)}
                      variant="outlined"
                    >
                      <Select.Option value="All">All Categories</Select.Option>
                    ...
                    <div className={progressStyles.searchCon} style={{ background: "#f8fafc", border: "1px solid #e2e8f0", height: "36px", width: "200px", minWidth: 0, flex: "1 1 auto" }}>
                      <SearchOutlined className={progressStyles.searchIcon} style={{ fontSize: "13px" }} />
                      <input
                        placeholder="Search questions..."
                        value={questionSearchQuery}
                                    ...
                                    if (e?.questionType?.includes("Comprehension")) {
                                      return (
                                        <Collapse
                                          ...
                                          expandIcon={({ isActive }) => (
                                            <TbTriangleInvertedFilled
                                              className={`${progressStyles.icon} ${isActive ? progressStyles.iconActive : progressStyles.iconInactive
                                                }`}
                                            />
                                          )}
                                          size="middle"
