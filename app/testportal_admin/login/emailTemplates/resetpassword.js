export function generateResetPasswordEmailTemplate(params){
...
<body >
    <div class="container" style="width: 100%;margin: 0;  background-color: #56d2d41a; font-family: 'Montserrat', sans-serif; box-sizing: border-box; padding: 1rem; max-width: 600px; margin: auto;">
        ...
        <div class="title" style=" margin-top:4rem;text-align: center; font-weight: 700; font-size: 1.725rem; line-height: 2.31rem; color: #2a8586ff; margin: 1.125rem 0;">
            Password Reset Request for Your <span style="color: #56D2D4;">Synsper</span>  Account
        </div>
 ...
 <div style="width: 100%;  margin: 1.4rem 0;  text-align: center;">   <a href=${params.url} style=" margin: 0 ; text-align: center;background-color: #56D2D4; color: black; text-decoration: none; font-weight: 600; padding: 0.4rem 2rem; border-radius: 2.5rem;">Reset Password</a>    
 </div>
