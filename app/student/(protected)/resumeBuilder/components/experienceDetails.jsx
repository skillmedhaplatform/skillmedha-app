...
import { 
  ...
  TagsOutlined, TrophyOutlined, AppstoreOutlined
...
const ExperienceDetails = ({
  ...
  const workExperiences = experiences?.filter((e) => e?.type?.toLowerCase() === "work") || [];

  // No auto-setting of editingId so List View shows by default

  const handleAdd = () => {
    addExperience();
    // The new item will be added at the end. We assume the parent component updates the array.
    // To set the editingId to the new item, we might need a small delay or we can let the user click it.
    // For now, if we add, we don't know the exact ID immediately if it's generated by parent, 
    // but the parent generates `id: Date.now()`.
  };

  const activeItem = workExperiences.find((item) => item.id === editingId) || workExperiences[0];
  const activeIndex = experiences.findIndex((item) => item.id === activeItem?.id);

  const renderAddedItems = () => (
    <div className="flex flex-col gap-3">
      <h4 className="font-bold text-[#0f172a] text-[16px] m-0">Added Experience</h4>
            ...
            <div className="flex items-center justify-between pb-6 border-b border-[#f1f5f9]">
              <div className="flex flex-col">
                ...
                <p className="text-[#64748b] text-[14px] m-0 ml-[32px]">
                  Add accurate details about your work experience.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex flex-col gap-1 md:col-span-2">
                  <label className="text-[13px] font-semibold text-[#475569]">Job Title / Role <span className="text-[#ef4444]">*</span></label>
                  <Input
