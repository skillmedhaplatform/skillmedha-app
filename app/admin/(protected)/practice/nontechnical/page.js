                ...
                >
                  {editing ? (
                    <Space>
                      <Tooltip
                        title={(() => {
                          const canSave = isTemp
                            ? canAccess(PERMISSION_VALUES.CREATE)
                            : canAccess(PERMISSION_VALUES.EDIT);
                          return !canSave
                            ? getPermissionMessage(
                                isTemp ? PERMISSION_VALUES.CREATE : PERMISSION_VALUES.EDIT
                              )
                            : "";
                        })()}
                      >
                    ...
                    <Space>
                      <Button
                        ...
                        disabled={
                          !record.title?.trim() || loading || isTemp
                        }
                        ...
                        >
                          <span>
                            <Popconfirm
                              ...
                              description={canAccess(PERMISSION_VALUES.DELETE) ? "This action cannot be undone." : ""}
                              okText="Delete"
                              cancelText="Cancel"
